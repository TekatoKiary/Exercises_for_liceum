...
if not is_create_sql_flie:
    ...
    add_user(db_sess, 'Scott', 'Ridley', 21, 'captain', 'research engineer', 'module_1', 'scott_chief@mars.org', '123')
...
api.add_resource(jobs_resources.JobsListResource, '/api/v2/job')
api.add_resource(jobs_resources.JobsResource, '/api/v2/job/<int:job_id>')
...
def edit_job(id):
    ...
    if request.method == "GET":
        ...
        if job:
            ...
            form.id_teamlead.data = job.team_leader
    ...
    if form.validate_on_submit():
        ...
        if job:
            ...
            job.team_leader = form.id_teamlead.data
